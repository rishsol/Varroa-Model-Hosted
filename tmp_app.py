...
def load_model():
    model_path = "models/varroa_det_model_v3"
...
def predict():
    ...
    class_names = ['No Varroa', 'Has Varroa']
    model = load_model()
    try:
        return flask.jsonify(classify('varroa_test_set/has_varroa/001_001.jpeg', model, class_names))
